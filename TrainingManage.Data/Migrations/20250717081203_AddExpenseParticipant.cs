...
{
    /// <inheritdoc />
    public partial class AddExpenseParticipant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseParticipants", x => new { x.ExpenseId, x.PersonId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseParticipants_Persons_PersonId",
                        column: x => x.PersonId,
